        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="offers.html"><img src="{{ asset('images/offer-1-370x270.jpg') }}" alt=""></a>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="offers.html"><img src="{{ asset('images/offer-2-370x270.jpg') }}" alt=""></a>
              <div class="down-content">
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="offers.html"><img src="{{ asset('images/offer-3-370x270.jpg') }}" alt=""></a>
              <div class="down-content">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item">
              <a href="#" class="services-item-image"><img src="{{ asset('images/blog-1-370x270.jpg') }}" class="img-fluid" alt=""></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item">
              <a href="#" class="services-item-image"><img src="{{ asset('images/blog-2-370x270.jpg') }}" class="img-fluid" alt=""></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item">
              <a href="#" class="services-item-image"><img src="{{ asset('images/blog-3-370x270.jpg') }}" class="img-fluid" alt=""></a>
